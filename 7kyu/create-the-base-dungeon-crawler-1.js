...
//
// Parameters
// name - The name parameter will be used to pass into the Player class which will then be stored in the property name player. This should have a default value of 'Player' if a name is null or empty.
// Properties
...
class Game {
  constructor(name, level){
    this.level = isNaN(parseInt(level)) ? 0 : parseInt(level)
